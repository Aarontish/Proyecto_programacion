...
public class HabitacionDAO {
    ...
    public List<Habitaciones> getHabitacionesByTipoId(int idTipo) {
        List<Habitaciones> habitaciones = new ArrayList<>();
        String sql = "SELECT idHabitacion, numero, idTipoHabitacion, numeroCamas, estado, descripcion, caracteristicas FROM Habitaciones WHERE idTipoHabitacion = ?";
