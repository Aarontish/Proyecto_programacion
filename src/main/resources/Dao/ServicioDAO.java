...
public class ServicioDAO {
    ...
    // 🔥 Nuevo método aquí
    public Servicios getServicioByName(String nombreServicio) {
        Servicios servicio = null;
        String sql = "SELECT idServicio, nombreServicio, precio, descripcion FROM Servicios WHERE nombreServicio = ?";
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            System.err.println("Error al obtener servicio por nombre: " + e.getMessage());
            e.printStackTrace();
        } finally {
            closeResources(conn, pstmt, rs);
        }
