...
public class menu {
	...
	private void initialize() {
		...
		ImageIcon p1 = new ImageIcon("images/cama_individual.png");
		...
		ImageIcon d1 = new ImageIcon("images/renta.png");
		...
		ImageIcon c1 = new ImageIcon("images/cama_doble.png");
		Image c2 = c1.getImage();
		Image c3 = c2.getScaledInstance(75, 80, Image.SCALE_SMOOTH); 
		botonTiposDeHabitaciones.setIcon(new ImageIcon(c3));
		botonTiposDeHabitaciones.setBorder(BorderFactory.createLineBorder(Color.BLACK,0));
		...
		ImageIcon e1 = new ImageIcon("images/tarifa_por_hora.png");
		Image e2 = e1.getImage();
		Image e3 = e2.getScaledInstance(55, 60, Image.SCALE_SMOOTH); 
		botonTarifas.setIcon(new ImageIcon(e3));
		panel_3.add(botonTarifas);
		
		JLabel decoracion = new JLabel(""); //imagen junto al menú
		decoracion.setBounds(730, 150, 424, 400);
		ImageIcon v1 = new ImageIcon("images/decoracion.png");
